...
class TestDockerComposePerformance(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # Optimization: Cache resource limits and reservations to avoid repeated dictionary lookups.
        traefik_resources = cls.traefik_deploy.get('resources', {})
        cls.traefik_limits = traefik_resources.get('limits', {})
        cls.traefik_reservations = traefik_resources.get('reservations', {})
        ...
        # Optimization: Cache resource limits and reservations to avoid repeated dictionary lookups.
        portainer_resources = cls.portainer_deploy.get('resources', {})
        cls.portainer_limits = portainer_resources.get('limits', {})
        cls.portainer_reservations = portainer_resources.get('reservations', {})
