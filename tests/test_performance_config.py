...
class TestDockerComposePerformance(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # Optimization: Cache resource limits and reservations to eliminate redundant dictionary lookups.
        resources = cls.traefik_deploy.get('resources', {})
        cls.traefik_limits = resources.get('limits', {})
        cls.traefik_reservations = resources.get('reservations', {})
        ...
        cls.traefik_env = normalize_config_list(cls.traefik.get('environment'))
        ...
        # Optimization: Cache resource limits and reservations to eliminate redundant dictionary lookups.
        resources = cls.portainer_deploy.get('resources', {})
        cls.portainer_limits = resources.get('limits', {})
        cls.portainer_reservations = resources.get('reservations', {})
    ...
    def test_traefik_resource_limits(self):
        ...
        # Optimization: Use cached resource dictionary for O(1) direct access.
    ...
    def test_traefik_http2_header_table_sizes(self):
        ...
        self.assertIn("--entrypoints.http.http2.maxencoderheadertablesize=131072", self.traefik_cmd_set)
    ...
    def test_traefik_reuse_port(self):
        """Verify Traefik reusePort optimization is enabled for the http entrypoint."""
