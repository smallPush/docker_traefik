...
class TestDockerComposePerformance(unittest.TestCase):
    ...
    def _normalize_env(service_config):
        ...
        if isinstance(env, list):
            # Optimization: Use dictionary comprehension and partition for faster/robust parsing of environment variables.
    ...
    def _normalize_labels(service_config):
        ...
        if isinstance(labels, list):
            # Optimization: Use dictionary comprehension and partition for faster/robust parsing of labels.
